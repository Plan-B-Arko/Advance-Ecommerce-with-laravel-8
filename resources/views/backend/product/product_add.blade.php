            ...
            <div class="row"> <!-- start 3rd row  -->
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="controls">
                         <input type="text" name="product_tags" data-role="tagsinput" class="form-control" required="" > </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="controls">
                            <input type="text" name="product_size" data-role="tagsinput" class="form-control" required=""> </div>
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="controls">
                         <input type="text" name="product_color" data-role="tagsinput" class="form-control" required="" > </div>
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <h5>Product Short Descraption<span class="text-danger">*</span></h5>
                          ...
                          <textarea name="product_short_descp" rows="15"  id="textarea" class="form-control" required placeholder="Textarea text"></textarea>
                ...
                <div class="col-md-9">
                    <div class="form-group">
                        <h5>Product Long Descraption<span class="text-danger">*</span></h5>
                        	<textarea id="editor1" name="product_long_descp" rows="5" cols="80" required=""></textarea>

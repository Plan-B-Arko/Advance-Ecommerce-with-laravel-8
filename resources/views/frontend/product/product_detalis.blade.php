	...
	<div class="container-fluid">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class="name" id="pname">{{ $product->product_name }}</li>
 ...
 <div class="detail-block">
  ...
  <div class="col-xs-12 col-sm-6 col-md-5 gallery-holder">
	...
	<div class="single-product-gallery-item" id="slide{{ $multiimg->id }}">
		<a data-fancybox="image-1" data-fancybox="Gallery" href="{{ asset($multiimg->photo_name) }}">
									...
									<div class="col-sm-2">
										<div class="cart-quantity">
											<div class="quant-input">
								                ...
								                <input type="text" value="1" id="qty" min="1" mix="5000">
												<input name="qty" id="qty" type="text" value="1" class="qty">
								...
								<div id="review" class="tab-pane">
									<div class="product-tab">
										...
										<div class="product-reviews">
											...
											<div class="reviews">
												<div class="review">
													<div class="review-title"><span class="summary">We love this product</span>
														<span class="date"><i class="fa fa-calendar"></i><span>1 days ago</span></span></div>

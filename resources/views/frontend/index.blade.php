                        ...
                        <div class="row product-micro-row">
                          <div class="col col-xs-5">
                            <div class="product-image">                              
                              <div class="image"> <a href="{{ url('product/detail/'. $special_offer->id ) }}"> <img src=" {{ asset( $special_offer->product_thambnail ) }}"alt=""> </a> </div>
                              <!-- /.image --> 
                          ...
                          <div class="col col-xs-7">
                            <div class="product-info">
                              <h3 class="name"><a href="{{ url('product/detail/'. $special_offer->id ) }}">{{ $special_offer->product_name }}</a></h3>
                    ...
                    <div class="product">
                      <div class="product-micro">
                        <div class="row product-micro-row">
                          <div class="col col-xs-5">
                            <div class="product-image">
                              <div class="image"> <a href="{{ url('product/detail/'. $special_deal->id ) }}"> <img src=" {{ asset( $special_deal->product_thambnail ) }}" alt=""> </a> </div>
                              <!-- /.image --> 
                          ...
                          <div class="col col-xs-7">
                            <div class="product-info">
                              <h3 class="name"><a href="{{ url('product/detail/'. $special_deal->id ) }}"> {{ $special_deal->product_name }} </a></h3>
                              <div class="rating rateit-small"></div>
                ...
                <div class="row">
                  <div class="col-md-12">
                    ...
                    <div class="wide-banner cnt-strip">
                      ...
                      <div class="image"> <img class="img-responsive" src="{{ asset ($bennar->bennar_img) }}"    alt="banner img No">

                      </div>
                        <div class="strip strip-text">
                        <div class="strip-inner ">
                          <h2 class="text-right">{{ $bennar->title }}<br>
                            <span class="shopping-needs ">{{ $bennar->description }}</span></h2>
                        </div>
                      </div>
                      <div class="new-label">

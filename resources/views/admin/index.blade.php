 ...
 <div class="container-full">
    ...
    <section class="content">
     ...
     <div class="col-xl-3 col-6">
        <div class="box overflow-hidden pull-up">
            <div class="box-body">
                <div class="icon bg-primary-light rounded w-60 h-60">
                    <i class="text-primary mr-0 font-size-24 glyphicon glyphicon-user"></i>
    ...
    <div class="col-xl-3 col-6">
        <div class="box overflow-hidden pull-up">
            <div class="box-body">
                <div class="icon bg-warning-light rounded w-60 h-60">
                    <i class="text-warning mr-0 font-size-24 glyphicon glyphicon-briefcase"></i>
                </div>
                <div>
                    @php
    ...
    <h3 class="text-white mb-0 font-weight-500">{{ $dueSalarys }} <small class="text-danger"><i class="fa fa-caret-up"></i>TK</small></h3>
                </div>
            </div>
        </div>
    </div>
